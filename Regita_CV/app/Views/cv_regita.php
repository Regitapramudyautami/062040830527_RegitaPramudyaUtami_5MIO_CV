...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Regita Pramudya Utami CV</title>
                    ...
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-lg-7">
                                <p>
                                Saya memiliki pengalaman kerja lebih dari 5 tahun sebagai software developer diberbagai perusahaan. Keterampilan yang saya kuasai adalah mampu berkomunikasi dan bekerja saa dengan tim, teliti dan bertanggung jawab terhadap pekerjaan. 
                                </p>
                ...
                <div class="education" id="education">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>04-juni-2019 <i>to</i> 04-juni-2022</span>
                                    <h3>Unversitas Indonesia</h3>
                                    <p>S3 Ilmu Komputer.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>01-Januari-2017 <i>to</i> 01-Januari-2019</span>
                            ...
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>10-Oktober-2013 <i>to</i> 10-Oktober-2017</span>
                            ...
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>07-Juli-2010 <i>to</i> 07-juli-2013</span>
                                    <h3>Senior High School</h3>
                                    <p>SMA NEGERI 5 OKU.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="experience" id="experience">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>07-Oktober-2022 <i>to</i> 31-Dec-2025</span>
                                    <h3>PT Sejahtera Bandung</h3>
                                    <h4>Bandung, Jawa Barat</h4>
                                    <h5>Manajer Proyek</h5>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>01-Maret-2026 <i>to</i> 31-Maret-2027</span>
                                    <h3>PT Bravo Satria Perkasa</h3>
                                    <h4>Palembang, Sumatera Selatan</h4>
                                    <h5>Web Developer</h5>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>19-Mei-2028 <i>to</i> 31-Januari-2030</span>
                                    <h3>PT Berlian Murni</h3>
                                    <h4>DKI Jakarta</h4>
                                    <h5>Desainer Web</h5>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>01-Maret-2030 <i>to</i> 31-Desember-2033</span>
                                    <h3>PT Global Sukses</h3>
                                    <h4>Yogyakarta</h4>
                        ...
                        <div class="row align-items-center review-slider">
                            <div class="col-md-12">
                                <div class="review-slider-item">
                                    <div class="review-text">
                                        <p>
                                        Regita membuat desain web yang sangat bagus dan sesuai dengan kebutuhan yang saya inginkan , sehingga pelanggan saya dapat dengan mudah mengakses web tersebut dan pelanggan saya menjadi meningkat.
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="review-slider-item">
                                    <div class="review-text">
                                        <p>
                                        Regita membuat desain web yang sangat bagus dan sesuai dengan kebutuhan yang saya inginkan , sehingga banyak orang yang ingin melakukan kursus online dengan saya.
                                        </p>
                                    </div>
                                    <div class="review-img">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="contact-info">
                                    <p><i class="fa fa-user"></i>Regita Pramudya Utami</p>
                                    ...
                                    <p><i class="fa fa-phone"></i><a href="tel:+6235758885356">+6235758885356</a></p>
                                    <p><i class="fa fa-map-marker"></i>Sepancar, OKU, Sumatera Selatan, Indonesia</p>
                                    <div class="social">
